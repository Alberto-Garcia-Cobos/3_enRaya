...
/*
    ...
    CREACION DE JUEGO 3 EN RAYA:
    Ilerna  Games  es  una  empresa  de  diseño  de  videojuegos  y  ha  contactado  con 
    nosotros.  

    Nos  comentan  que  su  programador  se  ha  puesto  de  baja  y  necesitan  acabar 
    urgentemente un juego. Consiste en realizar un tres en raya, y por suerte, tenemos 
    la parte de diseño y la estructura del juego montada. Únicamente faltan rellenar los 
    métodos y la parte lógica del juego.  
*/
public class Juego extends javax.swing.JFrame {
    /*
        • Están declaradas de forma global la matriz y la clase LogicaJuego.  
        • iniciarJuego(): Es el método que inicializará una nueva partida, tendremos que 
        llamar  al  método  iniciarPartida  de  la  clase  LogicaJuego.java  y  vaciar  los 
        botones.  
